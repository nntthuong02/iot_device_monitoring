...
//            try {
//                while (true) {
//                    val response = RetrofitInstance.api.getEnvironmentData()
//                    if (response.success) {
//                        binding.textView.text = "Nhiệt độ: ${response.temperature}°C"
//                        binding.textView2.text = "Độ ẩm: ${response.humidity}%"
//                    }
//                    delay(5000) // Cập nhật mỗi 5 giây
//                }
//            } catch (e: Exception) {
//                Log.e("API", "Failed to fetch environment data: ${e.message}")
//            }
//        }
//    }
//
//    private fun setupPersonDetection() {
//        lifecycleScope.launch {
//            try {
//                while (true) {
//                    val response = RetrofitInstance.api.detectPerson()
//                    if (response.success && response.isPersonDetected) {
//                        toggleLight("den1", binding.switchDen1, binding.imgLight1, true)
//                    }
//                    delay(3000) // Kiểm tra mỗi 3 giây
//                }
//            } catch (e: Exception) {
//                Log.e("API", "Failed to fetch person detection: ${e.message}")
//            }
//        }
//    }
//
//    private fun showTimePickerForLight(lightId: String, switchView: TextView, lightView: ImageView) {
//        val calendar = Calendar.getInstance()
//        val currentHour = calendar.get(Calendar.HOUR_OF_DAY)
//        val currentMinute = calendar.get(Calendar.MINUTE)
//
...
//                            switchView.text = String.format("%02d:%02d", minutes, seconds)
//                        }
//
//                        override fun onFinish() {
//                            toggleLight(lightId, switchView, lightView, false)
//                            Toast.makeText(this@MainActivity, "Thời gian đã hết!", Toast.LENGTH_SHORT).show()
//                        }
//                    }.start()
//                } else {
...
//    }
//
//    private fun toggleLight(lightId: String, switchView: TextView, lightView: ImageView, isOn: Boolean) {
//        viewModel.toggleDevice(lightId, if (isOn) 1 else 0, {
//            updateLightState(switchView, lightView, isOn)
//        }, { error ->
//            Toast.makeText(this, "Failed to toggle light: ${error.message}", Toast.LENGTH_SHORT).show()
//        })
//    }
//
//
